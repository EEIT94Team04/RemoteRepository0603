...
CustomerBean customer = customerDao.select("Alex");
out.println("customer="+customer+"<br>");

ProductDAOJdbc productDao = new ProductDAOJdbc();
List<ProductBean> products = productDao.select();
out.println("products="+products+"<br>");
%>
